...
const mobileMenuCloseButtonWb = document
  .querySelector('.mobile-menu-wb__button');
...
const bureauOctoberNovember1819MembersList = document
  .querySelectorAll('#bureauOctoberNovember1819 .office-committee-member-card');
const bureauOctoberNovember1819Button = document
  .querySelector(
    '#bureauOctoberNovember1819 .office-committee-members__button'
  );
...
const proSudListTogglerFuction = (list, button, sectionId) => {
  if (list.length > 0 && button) {
    button.addEventListener('click', () => {
      ...
      const buttonShown = document
        .querySelector(
          `#${sectionId} .office-committee-members__button--shown`
        );
...
const committeeOctoberNovember1819MembersList = document
  .querySelectorAll(
    '#committeeOctoberNovember1819 .office-committee-member-card'
  );
const committeeOctoberNovember1819Button = document
  .querySelector(
    '#committeeOctoberNovember1819 .office-committee-members__button'
  );
...
const proSudListTogglerFuctionWb = (list, button, sectionId) => {
  if (list.length > 0 && button) {
    button.addEventListener('click', () => {
      ...
      const buttonShown = document
        .querySelector(
          `#${sectionId} .office-committee-members-wb__button--shown`
        );
...
const bureauOctoberNovember1819MembersListWb = document
  .querySelectorAll(
    '#bureauOctoberNovember1819wb .office-committee-member-card-wb'
  );
const bureauOctoberNovember1819ButtonWb = document
  .querySelector(
    '#bureauOctoberNovember1819wb .office-committee-members-wb__button'
  );
...
const committeeOctoberNovember1819MembersListWb = document
  .querySelectorAll(
    '#committeeOctoberNovember1819wb .office-committee-member-card-wb'
  );
const committeeOctoberNovember1819ButtonWb = document
  .querySelector(
    '#committeeOctoberNovember1819wb .office-committee-members-wb__button'
  );
